...
private slots:
    ...
    QString BuyCRAVE(QString OrderType, double Quantity, double Rate);
    QString SellCRAVE(QString OrderType, double Quantity, double Rate);
