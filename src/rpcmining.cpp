...
Value getsubsidy(const Array& params, bool fHelp)
{
    ...
    return (int64_t)GetProofOfStakeReward(pindexBest->pprev, 0, 0, pindex->nHeight);
}
...
Value getstakesubsidy(const Array& params, bool fHelp)
{
    ...
    return (uint64_t)GetProofOfStakeReward(pindexBest->pprev, nCoinAge, 0, pindex->nHeight);
}
...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("blockvalue",    (int64_t)GetProofOfStakeReward(pindexBest->pprev, 0, 0, pindex->nHeight)));
